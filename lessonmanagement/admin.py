...
class LessonScheduleResource(resources.ModelResource):
    class Meta:
        ...
        fields = ('id','lesson__teacher__firstname','lesson__teacher__lastname', 'classyear__startyear__start_date', 'classyear__title','week','session', 'order_schedule', 'teach_date_schedule'  )
