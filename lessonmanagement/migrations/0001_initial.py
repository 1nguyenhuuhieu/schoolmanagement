# Generated by Django 3.2 on 2021-06-05 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schoolyear', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lessonmanagement.schoolyear', verbose_name='năm học')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
        ...
        migrations.AddField(
            model_name='lesson',
            name='week',
            field=models.ForeignKey(blank=True, help_text='Sử dụng vào tuần nào', null=True, on_delete=django.db.models.deletion.CASCADE, to='lessonmanagement.weekschoolyear'),
        ),
        migrations.CreateModel(
