    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='lessonmanagement.groupsubject', verbose_name='Bộ môn')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Số bài giảng môn học ',
                'verbose_name_plural': 'Số bài giảng môn học ',
            },
        ),
        migrations.CreateModel(
            name='Teacher',
            fields=[
                ...
                ('user', models.OneToOneField(help_text='Tài khoản đăng nhập viết liền không dấu. Ví dụ: nhhieu. Viết tắt của Nguyễn Hữu Hiếu. Nếu trùng họ tên thì thêm số vào sau, ví dụ nhhieu2', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Tài khoản đăng nhập')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lessonmanagement.subjectlesson')),
            ],
            options={
